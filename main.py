...
# bot
bot_token = os.environ.get("TOKEN", "6934514903:AAHLVkYqPEwyIZiyqEhJocOrjDYwTk9ue8Y")
api_hash = os.environ.get("HASH", "558df3cdc4820fd2de0950656e8112f3") 
api_id = os.environ.get("ID", "25582726")
